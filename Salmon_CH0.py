...
WHERE [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGR]
...
INSERT INTO [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS] ([Tag Code])
...
AND [Tag Code] NOT IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS])"""

Above_LGRPopulateNew = """UPDATE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS]
SET Spp = 'Chinook'
WHERE Spp IS NULL

MERGE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS] AS b
...
UPDATE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS]
SET LGR = 1

MERGE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS] AS a
...
USING (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[CHK_Clean_Detections]
		...
		AND [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGR]
...
WHERE [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS]
						WHERE Below_LGS = 1)
AND [Tag Code] NOT IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN])
AND [Site Name] IN (/*'GOJ - Little Goose Dam Juvenile',*/
					'LMJ - Lower Monumental Dam Juvenile'/*,
					'MCJ - McNary Dam Juvenile',
					'MCX - MCNARY JUVENILE EXPERIMENTAL'*/)
...
INSERT INTO [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN] ([Tag Code])
SELECT [Tag Code] FROM a
WHERE ((MONTH(Last_LMN) = 6 AND DAY(Last_LMN) BETWEEN 3 AND 31)
		OR (MONTH(Last_LMN) = 7 AND DAY(Last_LMN) BETWEEN 1 AND 8))
AND [Tag Code] NOT IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN])"""

LGRSkippers_LMNPopulateNew = """UPDATE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN]
SET Spp = 'Chinook'
WHERE Spp IS NULL

MERGE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN] AS b
...
UPDATE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN]
SET LGS = 1

MERGE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN] AS a
USING (SELECT  DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[CHK_Clean_Detections]
		WHERE [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS]
						WHERE Below_LGS = 1)
...
WHERE [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN]
						WHERE Below_LMN = 1)
AND [Tag Code] NOT IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN])
AND [Site Name] IN (/*'GOJ - Little Goose Dam Juvenile',
					'LMJ - Lower Monumental Dam Juvenile',*/
					'MCJ - McNary Dam Juvenile',
					'MCX - MCNARY JUVENILE EXPERIMENTAL')
...
INSERT INTO [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN] ([Tag Code])
SELECT [Tag Code] FROM a
WHERE ((MONTH(Last_MCN) = 6 AND DAY(Last_MCN) BETWEEN 3 AND 31)
		OR (MONTH(Last_MCN) = 7 AND DAY(Last_MCN) BETWEEN 1 AND 8))
AND [Tag Code] NOT IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN])"""

LGRSkippers_MCNPopulateNew = """UPDATE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN]
SET Spp = 'Chinook'
WHERE Spp IS NULL

MERGE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN] AS b
...
UPDATE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN]
SET LMN = 1

MERGE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN] AS a
USING (SELECT  DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[CHK_Clean_Detections]
		WHERE [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN]
						WHERE Below_LMN = 1)
		AND [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[CHK_Clean_Detections]
...
LGR_LGSSkippersPopulateNew = """UPDATE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN]
SET Spp = 'Chinook'
WHERE Spp IS NULL
...
LGSSkippers_MCNPopulateNew = """UPDATE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN]
SET Spp = 'Chinook'
WHERE Spp IS NULL
...
LMN_MCNSkippersPopulateNew = """UPDATE [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN]
SET Spp = 'Chinook'
WHERE Spp IS NULL
...
USING (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[CHK_Clean_Detections]
		WHERE [Site Name] IN ('MCJ - McNary Dam Juvenile',
							'MCX - MCNARY JUVENILE EXPERIMENTAL')
		AND ([Antenna Group Name] LIKE '%SAMPLE%' OR [Antenna Group Name] LIKE '%RACEWAY%')
		AND [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS]
...
SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[CHK_Clean_Detections]
WHERE ([Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGR])
OR [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS]))
AND [Tag Code] NOT IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN])
AND ([Site Name] IN (/*'LMJ - Lower Monumental Dam Juvenile',
					'ICH - Ice Harbor Dam (Combined)',*/
					'MCJ - McNary Dam Juvenile',
...
WHERE ([Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGR])
OR [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LGS])
OR [Tag Code] IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_LMN]))
AND [Tag Code] NOT IN (SELECT DISTINCT [Tag Code] FROM [LGR_IHR_PSE_3].[dbo].[Salmon_CH0_MCN])
AND ([Site Name] IN (/*'LMJ - Lower Monumental Dam Juvenile',
					'ICH - Ice Harbor Dam (Combined)',
					'MCJ - McNary Dam Juvenile',
